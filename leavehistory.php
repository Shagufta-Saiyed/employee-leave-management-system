                        ...
                        <div class="card-content">
                            ...
                            <table id="example" class="display responsive-table ">
                                ...
                                <tbody>
                                    <?php
                                    $eid = $_SESSION['eid'];
                                    $sql = "SELECT leave_type,to_date,from_date,description,posting_date,remark_date,admin_remark,status from leave where empid=:eid";
                                    ...
                                    if ($query->rowCount() > 0) {
                                        foreach ($results as $result) {               ?>
                                            <tr>
                                                ...
                                                <td><?php if ($result->admin_remark == "") {
                                                        echo htmlentities('waiting for approval');
                                                    } else {

                                                        echo htmlentities(($result->admin_remark) . " " . "at" . " " . $result->remark_date);
                                                    }
