...
// Code to change password when forgotten 
if (isset($_POST['change'])) {
    $newpassword = md5($_POST['newpassword']);
    $empid = $_SESSION['empid'];

    $con = "update employee set password=:newpassword where id=:empid";
                    ...
                    <div class="col s12 m6 l8 offset-l2 offset-m3">
                        <div class="card white darken-1">
                            ...
                            <?php if (isset($_POST['submit'])) {
                                $empid = $_POST['empid'];
                                $email = $_POST['emailid'];
                                $sql = "SELECT id FROM employee WHERE email_id=:email and empid=:empid";
