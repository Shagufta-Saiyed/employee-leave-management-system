...
$sql="update leavetype set leave_type=:leavetype,description=:description where id=:lid";
...
<input id="leavetype" type="text"  class="validate" autocomplete="off" name="leavetype" value="<?php echo htmlentities($result->leave_type);?>"  required>
