                        ...
                        <div class="col s12 m12 l12">
                            <div class="card invoices-card">
                             ...
                             <table id="example" class="display responsive-table ">
                                    ...
                                    <tbody>
<?php $sql = "SELECT leave.id as lid,employee.fname,employee.lname,employee.empid,employee.id,leave.leave_type,leave.posting_date,leave.status from leave join employee on leave.empid=employee.id order by lid desc limit 6";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
