...
$sql="INSERT INTO employee(empid,fname,lname,email_id,password,gender,dob,dept_id,address,city,country,phone_no,status) VALUES(:empid,:fname,:lname,:email,:password,:gender,:dob,:department,:address,:city,:country,:mobileno,:status)";
