...
$sql="update employee set fname=:fname,lname=:lname,gender=:gender,dob=:dob,dept_id=:dept_id,address=:address,city=:city,country=:country,phone_no=:mobileno where id=:eid";
...
<?php $sql = "SELECT dept_id from department";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
