...
if (strlen($_SESSION['emplogin']) == 0) {
    ...
    if (isset($_POST['apply'])) {
        ...
        $sql = "INSERT INTO leave(leave_type,to_date,from_date,description,status,is_read,empid) VALUES(:leavetype,:fromdate,:todate,:description,:status,:isread,:empid)";
                                                            ...
                                                            <select name="leavetype" autocomplete="off">
                                                                ...
                                                                if ($query->rowCount() > 0) {
                                                                    foreach ($results as $result) {   ?>
                                                                        <option value="<?php echo htmlentities($result->leave_type); ?>"><?php echo htmlentities($result->leave_type); ?></option>
                                                                <?php }
                                                                } ?>
                                                            </select>
                                                        </div>
